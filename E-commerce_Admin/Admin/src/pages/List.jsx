      ...
      <div className="flex flex-col gap-2">
        ...
        {List.length > 0 ? (
          List.map((item) => (
            <div
              key={item._id}
              className="hidden md:grid grid-cols-6 gap-4 items-center py-2 px-4 border bg-gray-50 text-sm"
            >
              <img
              ...
              <span
                ...
                className="col-span-1 text-center cursor-pointer text-red-500 hover:text-red-700 transition-all ease-in-out duration-300 font-bold text-lg"
              >
                ✖
              </span>
            </div>
